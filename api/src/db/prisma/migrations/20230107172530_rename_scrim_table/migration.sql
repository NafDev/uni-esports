/*
  ...
  - You are about to drop the `Scrim` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "Scrim" DROP CONSTRAINT "Scrim_accepting_team_id_fkey";

-- DropForeignKey
ALTER TABLE "Scrim" DROP CONSTRAINT "Scrim_game_id_fkey";

-- DropForeignKey
ALTER TABLE "Scrim" DROP CONSTRAINT "Scrim_requesting_team_id_fkey";
