...
<script lang="ts">
	...
	import NewTeamDialog from '$components/teams/newTeamDialog.svelte';
	import Modal from '$components/base/modal.svelte';

	let newTeamDialog = false;
</script>
...
<Modal bind:open={newTeamDialog}>
	<NewTeamDialog />
</Modal>

<div class="flex flex-row items-center justify-between px-10">
	<p class="my-8 text-2xl">Your Teams</p>
	<button class="btn primary" on:click={() => (newTeamDialog = true)}>Create Team</button>
</div>
